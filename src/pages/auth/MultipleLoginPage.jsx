/**
 * src/pages/auth/MultipleLoginPage.jsx
 * ======================================
 * Multiple login detection page — shown when the user is already logged in
...
const MultipleLoginPage = () => (
  <div className="min-h-screen bg-white flex flex-col font-['Inter']">
    ...
    <div className="flex-1 flex flex-col items-center justify-center text-center px-6">
      ...
      <h1 className="text-[22px] font-bold text-navy mb-4">Multiple Logins Detected</h1>
      ...
      <p className="text-[14px] text-gray-600">
        ...
        <Link to="/login" className="text-blue font-medium underline">
          here
        </Link>{' '}
        to login again.
      </p>
